...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(link                                             ((t (:foreground ,color-13 :underline t :weight medium))))
   `(link-visited                                     ((t (:foreground ,color-11 :underline t :weight light))))
   ...
   `(fringe                                           ((t (:foreground ,color-7 :weight medium))))
   `(highlight                                        ((t (:background ,color-4))))
   `(success                                          ((t (:foreground ,color-9 :weight medium))))
   `(warning                                          ((t (:background ,color-6 :foreground ,color-11 :weight medium))))
   `(error                                            ((t (:foreground ,color-14 :background ,color-5 :weight medium))))
   ;; compilation
   ...
   `(compilation-warning-face                         ((t (:foreground ,color-11 :weight medium :underline t))))
   `(compilation-mode-line-exit                       ((t (:foreground ,color-11 :weight medium))))
   `(compilation-mode-line-fail                       ((t (:foreground ,color-10 :weight medium))))
   `(compilation-mode-line-run                        ((t (:foreground ,color-13 :weight medium))))
   ;; grep
   `(grep-context-face                                ((t (:foreground ,color-13))))
   `(grep-error-face                                  ((t (:foreground ,color-9 :weight medium :underline t))))
   `(grep-hit-face                                    ((t (:foreground ,color-11))))
   `(grep-match-face                                  ((t (:foreground ,color-11 :weight medium))))
   `(match                                            ((t (:background ,color-3 :foreground ,color-11 :weight medium))))
   ;; make
   `(makefile-space                                   ((t (:background ,color-4))))
   `(makefile-targets                                   ((t (:underline t))))
   `(makefile-shell                                   ((t (:slant italic))))
   ;; isearch
   `(isearch                                          ((t (:foreground ,color-11 :weight medium :background ,color-6))))
   `(isearch-fail                                     ((t (:foreground ,color-13 :background ,color-7))))
   `(lazy-highlight                                   ((t (:foreground ,color-11 :weight medium :background ,color-5))))
   ...
   `(mode-line-buffer-id                              ((t (:foreground ,color-14 :weight medium))))
   ...
   `(font-lock-constant-face                          ((t (:foreground ,color-9 :weight medium))))
   `(font-lock-doc-face                               ((t (:foreground ,color-8 :weight light :italic t))))
   ...
   `(font-lock-regexp-grouping-construct              ((t (:foreground ,color-13 :weight medium))))
   `(font-lock-regexp-grouping-backslash              ((t (:foreground ,color-9 :weight medium))))
   ...
   `(newsticker-treeview-new-face                     ((t (:foreground ,color-11 :weight medium))))
   ...
   ;; anzu
   `(anzu-mode-line                                   ((t (:foreground ,color-12 :weight medium))))
   ;; full-ack
   `(ack-separator                                    ((t (:foreground ,color-13))))
   `(ack-file                                         ((t (:foreground ,color-11))))
   `(ack-line                                         ((t (:foreground ,color-13))))
   `(ack-match                                        ((t (:foreground ,color-11 :background ,color-3 :weight medium))))
   ;; auctex
   `(font-latex-bold-face                             ((t (:inherit bold))))
   `(font-latex-warning-face                          ((t (:foreground nil :inherit font-lock-warning-face))))
   `(font-latex-sectioning-5-face                     ((t (:foreground ,color-10 :weight medium ))))
   ...
   ;; clojure-test-mode
   `(clojure-test-failure-face                        ((t (:foreground ,color-11 :weight medium :underline t))))
   `(clojure-test-error-face                          ((t (:foreground ,color-10 :weight medium :underline t))))
   `(clojure-test-success-face                        ((t (:foreground ,color-10 :weight medium :underline t))))
   ;; coq
   ...
   `(diff-refine-added                                ((t :inherit diff-added :weight medium)))
   `(diff-refine-change                               ((t :inherit diff-changed :weight medium)))
   `(diff-refine-removed                              ((t :inherit diff-removed :weight medium)))
   ...
   ;; eshell
   `(eshell-prompt                                    ((t (:foreground ,color-13 :weight medium))))
   `(eshell-ls-archive                                ((t (:foreground ,color-9 :weight medium))))
   `(eshell-ls-backup                                 ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-clutter                                ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-directory                              ((t (:foreground ,color-11 :weight medium))))
   `(eshell-ls-executable                             ((t (:foreground ,color-11 :weight medium))))
   `(eshell-ls-unreadable                             ((t (:foreground ,color-13))))
   `(eshell-ls-missing                                ((t (:inherit font-lock-warning-face))))
   `(eshell-ls-product                                ((t (:inherit font-lock-doc-face))))
   `(eshell-ls-special                                ((t (:foreground ,color-13 :weight medium))))
   `(eshell-ls-symlink                                ((t (:foreground ,color-12 :weight medium))))
   ;; flx
   `(flx-highlight-face                               ((t (:foreground ,color-11 :weight medium))))
   ;; flycheck
   `(flycheck-error                                   ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-10) :inherit unspecified)) (t (:foreground ,color-7 :weight medium :underline t))))
   `(flycheck-warning                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-9) :inherit unspecified)) (t (:foreground ,color-9 :weight medium :underline t))))
   `(flycheck-info                                    ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-8) :inherit unspecified)) (t (:foreground ,color-10 :weight medium :underline t))))
   `(flycheck-fringe-error                            ((t (:inherit error))))
   `(flycheck-fringe-warning                          ((t (:inherit fringe))))
   `(flycheck-fringe-info                             ((t (:inherit fringe))))
   ;; flymake
   `(flymake-errline                                  ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-10) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-9 :weight medium :underline t))))
   `(flymake-warnline                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-11) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-11 :weight medium :underline t))))
   `(flymake-infoline                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-9) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-8 :weight medium :underline t))))
   ;; flyspell
   `(flyspell-duplicate                               ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-11) :inherit unspecified)) (t (:foreground ,color-11 :weight medium :underline t))))
   `(flyspell-incorrect                               ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-10) :inherit unspecified)) (t (:foreground ,color-9 :weight medium :underline t))))
   ;; erc
   `(erc-action-face                                  ((t (:inherit erc-default-face))))
   `(erc-bold-face                                    ((t (:weight medium))))
   `(erc-current-nick-face                            ((t (:foreground ,color-11 :weight medium))))
   ...
   `(erc-keyword-face                                 ((t (:foreground ,color-11 :weight medium))))
   `(erc-nick-default-face                            ((t (:foreground ,color-13 :weight medium))))
   `(erc-my-nick-face                                 ((t (:foreground ,color-10 :weight medium))))
   `(erc-nick-msg-face                                ((t (:inherit erc-default))))
   `(erc-notice-face                                  ((t (:foreground ,color-9))))
   `(erc-pal-face                                     ((t (:foreground ,color-11 :weight medium))))
   `(erc-prompt-face                                  ((t (:foreground ,color-11 :background ,color-4 :weight medium))))
   ...
   `(gnus-summary-high-read                           ((t (:foreground ,color-9 :weight medium))))
   `(gnus-summary-high-ticked                         ((t (:foreground ,color-11 :weight medium))))
   `(gnus-summary-high-unread                         ((t (:foreground ,color-13 :weight medium))))
   `(gnus-summary-low-ancient                         ((t (:foreground ,color-11))))
   `(gnus-summary-low-read                            ((t (:foreground ,color-9))))
   `(gnus-summary-low-ticked                          ((t (:foreground ,color-11 :weight medium))))
   ...
   `(gnus-summary-normal-ticked                       ((t (:foreground ,color-11 :weight medium))))
   `(gnus-summary-normal-unread                       ((t (:foreground ,color-13))))
   `(gnus-summary-selected                            ((t (:foreground ,color-13 :weight medium))))
   ...
   `(helm-ff-directory                                ((t (:foreground ,color-12 :background ,color-4 :weight medium))))
   `(helm-ff-file                                     ((t (:foreground ,color-13 :background ,color-4 :weight light))))
   `(helm-ff-executable                               ((t (:foreground ,color-11 :background ,color-4 :weight light))))
   `(helm-ff-invalid-symlink                          ((t (:foreground ,color-10 :background ,color-4 :weight medium))))
   `(helm-ff-symlink                                  ((t (:foreground ,color-13 :background ,color-4 :weight medium))))
   `(helm-ff-prefix                                   ((t (:foreground ,color-5 :background ,color-13 :weight light))))
   ...
   `(helm-M-x-key                                     ((t (:foreground ,color-12 :background ,color-4 :weight medium))))

   `(helm-swoop-target-word-face                      ((t (:foreground ,color-14 :background ,color-5 :weight medium))))
   ...
   ;; hl-sexp
   `(hl-sexp-face                                     ((,class (:background ,color-6)) (t :weight medium)))
   ;; ido-mode
   `(ido-first-match                                  ((t (:foreground ,color-13 :weight medium))))
   `(ido-only-match                                   ((t (:foreground ,color-11 :weight medium))))
   `(ido-subdir                                       ((t (:foreground ,color-13))))
   `(ido-indicator                                    ((t (:foreground ,color-13 :background ,color-7))))
   ;; iedit-mode
   `(iedit-occurrence                                 ((t (:background ,color-7 :weight medium))))
   ;; js2-mode
   ...
   `(jabber-title-small                               ((t (:height ,(tao-theme-height 1.1) :weight medium))))
   `(jabber-title-medium                              ((t (:height ,(tao-theme-height 1.2) :weight medium))))
   `(jabber-title-large                               ((t (:height ,(tao-theme-height 1.3) :weight medium))))
   ;; ledger-mode
   `(ledger-font-payee-uncleared-face                 ((t (:foreground ,color-9 :weight medium))))
   `(ledger-font-payee-cleared-face                   ((t (:foreground ,color-13 :weight light))))
   `(ledger-font-xact-highlight-face                  ((t (:background ,color-6))))
   `(ledger-font-pending-face                         ((t (:foreground ,color-11 :weight light))))
   ...
   `(ledger-font-reconciler-uncleared-face            ((t (:foreground ,color-9 :weight medium))))
   `(ledger-font-reconciler-cleared-face              ((t (:foreground ,color-13 :weight light))))
   `(ledger-font-reconciler-pending-face              ((t (:foreground ,color-11 :weight light))))
   `(ledger-font-report-clickable-face                ((t (:foreground ,color-11 :weight light))))
   ;; linum-mode
   ...
   ;; magit
   `(magit-section-title                              ((t (:foreground ,color-13 :weight medium))))
   `(magit-section-highlight                          ((t (:foreground ,color-15 :weight light))))
   `(magit-section-heading-selection                  ((t (:foreground ,color-13 :weight medium))))
   `(magit-section-heading                            ((t (:foreground ,color-13 :weight medium))))
   `(magit-branch                                     ((t (:foreground ,color-11 :weight medium))))
   ...
   `(message-header-to                                ((t (:foreground ,color-13 :weight medium))))
   `(message-header-from                              ((t (:foreground ,color-13 :weight medium))))
   `(message-header-cc                                ((t (:foreground ,color-13 :weight medium))))
   `(message-header-newsgroups                        ((t (:foreground ,color-13 :weight medium))))
   `(message-header-subject                           ((t (:foreground ,color-11 :weight medium))))
   `(message-header-xheader                           ((t (:foreground ,color-9))))
   `(message-mml                                      ((t (:foreground ,color-13 :weight medium))))
   ...
   `(mew-face-header-marginal                         ((t (:foreground ,color-13 :weight medium))))
   ...
   `(holiday                                          ((t (:background ,color-5 :weight medium))) t)
   `(diary                                          ((t (:background ,color-4 :box ,(tao-boxed t)))) t)   
   ;; org-mode
   `(org-agenda-date-today                            ((t (:foreground ,color-14 :slant italic :weight medium))) t)
   `(org-agenda-clocking                              ((t (:foreground ,color-14 :weight medium))) t)
   `(org-agenda-structure                             ((t (:inherit font-lock-comment-face))))
   `(org-archived                                     ((t (:foreground ,color-13 :weight medium))))
   ...
   `(org-tag                                          ((t (:bold t :weight light :italic nil :foreground ,color-8))))
   `(org-time-grid                                    ((t (:foreground ,color-11))))
   `(org-done                                         ((t (:bold t :background ,color-6 :foreground ,color-12 :weight light))))
   `(org-todo                                         ((t (:bold t  :background ,color-9  :foreground ,color-2 :weight light))))
   `(org-upcoming-deadline                            ((t (:inherit font-lock-keyword-face))))
   `(org-warning                                      ((t (:bold t :foreground ,color-10 :weight medium :underline nil))))
   `(org-column                                       ((t (:background ,color-3))))
   `(org-column-title                                 ((t (:background ,color-3 :underline t :weight medium))))
   ...
   ;; show-paren
   `(show-paren-mismatch                              ((t (:foreground ,color-1 :background ,color-14 :weight medium))))
   ...
   ;; undo-tree
   `(undo-tree-visualizer-active-branch-face          ((t (:foreground ,color-14 :weight medium))))
   `(undo-tree-visualizer-current-face                ((t (:foreground ,color-9 :weight medium))))
   ...
   ;; emacs-w3m
   `(w3m-anchor                                       ((t (:foreground ,color-12 :background ,color-4 :underline t :weight light))))
   `(w3m-current-anchor                               ((t (:foreground ,color-1 :background ,color-10 :underline nil :weight medium))))
   `(w3m-arrived-anchor-face                          ((t (:foreground ,color-9 :background ,color-4 :underline t :weight light))))
   `(w3m-image-anchor-face                            ((t (:foreground ,color-12  :background ,color-5 :underline t :weight light))))
   `(w3m-image-face                                   ((t (:foreground ,color-11 :background ,color-5 :underline t :weight light))))
   `(w3m-image-anchor                                 ((t (:foreground ,color-11 :background ,color-5 :underline t :weight light))))
   `(w3m-form                                         ((t (:foreground ,color-9 :underline t))))
   `(w3m-header-line-location-title                   ((t (:foreground ,color-7 :background ,color-5 :underline nil :weight light))))
   `(w3m-header-line-location-content                 ((t (:foreground ,color-13 :background ,color-5 :underline nil :weight light))))
   `(w3m-history-current-url                          ((t (:inherit match))))
   `(w3m-tab-background                               ((t (:foreground ,color-1 :background ,color-9 :underline nil :weight light))))
   `(w3m-tab-unselected-retrieving                    ((t (:foreground ,color-1 :background ,color-9 :underline nil :weight light))))
   `(w3m-tab-selected-background-face                 ((t (:foreground ,color-1 :background ,color-11 :underline nil :weight medium))))
   `(w3m-tab-selected-retrieving                      ((t (:foreground ,color-1 :background ,color-11 :underline nil :weight medium))))
   `(w3m-lnum                                         ((t (:foreground ,color-1 :background ,color-9 :underline nil :bold t ))))
   `(w3m-lnum-match                                   ((t (:background ,color-3 :foreground ,color-11 :weight medium))))
   ...
   `(web-mode-css-pseudo-class-face                   ((t (:foreground ,color-12 :weight medium))))
   ...
   `(wl-highlight-summary-displaying-face             ((t (:underline t :weight medium))))
   ;; which-func-mode
   ...
   ;; markdown mode
   `(markdown-header-delimiter-face                   ((t (:weight light :foreground ,color-6))))
   ...
   `(company-preview-common                           ((t (:inherit company-preview :foreground ,color-13 :weight medium))))
   ...
   ;; circe
   `(circe-highlight-nick-face                      ((t (:background ,color-6 :foreground ,color-11 :weight medium))))
